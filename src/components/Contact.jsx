      ...
      <div className="flex flex-col lg:flex-row gap-12">
        <div className="lg:w-1/2">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {formStatus === 'success' && (
              <div className="p-3 bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 rounded-lg mt-4">
                Your message has been sent successfully!
              </div>
            )}

            {formStatus === 'error' && (
              <div className="p-3 bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 rounded-lg mt-4">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:johndoe@example.com" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                  johndoe@example.com
                </a>
              </div>
            </div>
