...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center bg-gradient-to-br from-white to-blue-50 dark:from-gray-900 dark:to-gray-800">
      {/* Animated background dots (light theme only) */}
      {theme === 'light' && (
        <div className="absolute inset-0 overflow-hidden z-0">
          <div className="absolute w-full h-full bg-[radial-gradient(#3B82F6_1px,transparent_1px)] [background-size:20px_20px] opacity-10"></div>
        </div>
      )}
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 mt-12 lg:mt-0 animate-slideInRight">
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full bg-gradient-to-r from-blue-400 to-purple-500 mx-auto overflow-hidden">
                {/* Profile image placeholder */}
                <div className="w-full h-full bg-gray-300 dark:bg-gray-700 flex items-center justify-center text-4xl font-bold text-white">
                  JD
                </div>
              </div>
              <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-teal-400 rounded-full z-[-1] opacity-50"></div>
              <div className="absolute -top-4 -left-4 w-24 h-24 bg-purple-400 rounded-full z-[-1] opacity-50"></div>
            </div>
          </div>
        </div>
